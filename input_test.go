...
func TestInputRender(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			InputTemplateData{},
			fmt.Sprintf("%s What is your favorite month: ", core.QuestionIcon.Symbol),
		},
		{
			"Test Input question output with default",
			Input{Message: "What is your favorite month:", Default: "April"},
			InputTemplateData{},
			fmt.Sprintf("%s What is your favorite month: (April) ", core.QuestionIcon.Symbol),
		},
		{
		...
		},
		{
			...
			InputTemplateData{},
			fmt.Sprintf("%s What is your favorite month: [%s for help] ", core.QuestionIcon.Symbol, core.HelpInputIcon.Symbol),
		},
		{
			...
			InputTemplateData{},
			fmt.Sprintf("%s What is your favorite month: [%s for help] (April) ", core.QuestionIcon.Symbol, core.HelpInputIcon.Symbol),
		},
		{
			"Test Input question output without default but with help shown",
			Input{Message: "What is your favorite month:", Help: "This is helpful"},
			InputTemplateData{ShowHelp: true},
			fmt.Sprintf("%s This is helpful\n%s What is your favorite month: ", core.HelpIcon.Symbol, core.QuestionIcon.Symbol),
		},
		{
			"Test Input question output with default and with help shown",
			Input{Message: "What is your favorite month:", Default: "April", Help: "This is helpful"},
			InputTemplateData{ShowHelp: true},
			fmt.Sprintf("%s This is helpful\n%s What is your favorite month: (April) ", core.HelpIcon.Symbol, core.QuestionIcon.Symbol),
		},
	}
