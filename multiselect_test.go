...
func TestMultiSelectRender(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			strings.Join(
				[]string{
					fmt.Sprintf("%s Pick your words:  [Use arrows to move, type to filter]", core.QuestionIcon.Symbol),
					fmt.Sprintf("  %s  foo", core.UnmarkedOptionIcon.Symbol),
					fmt.Sprintf("  %s  bar", core.MarkedOptionIcon.Symbol),
					fmt.Sprintf("%s %s  baz", core.SelectFocusIcon.Symbol, core.UnmarkedOptionIcon.Symbol),
					fmt.Sprintf("  %s  buz\n", core.MarkedOptionIcon.Symbol),
				},
				"\n",
			),
		},
		...
		},
		{
			...
			strings.Join(
				[]string{
					fmt.Sprintf("%s Pick your words:  [Use arrows to move, type to filter, %s for more help]", core.QuestionIcon.Symbol, core.HelpInputIcon.Symbol),
					fmt.Sprintf("  %s  foo", core.UnmarkedOptionIcon.Symbol),
					fmt.Sprintf("  %s  bar", core.MarkedOptionIcon.Symbol),
					fmt.Sprintf("%s %s  baz", core.SelectFocusIcon.Symbol, core.UnmarkedOptionIcon.Symbol),
					fmt.Sprintf("  %s  buz\n", core.MarkedOptionIcon.Symbol),
		...
		},
		{
			...
			strings.Join(
				[]string{
					fmt.Sprintf("%s This is helpful", core.HelpIcon.Symbol),
					fmt.Sprintf("%s Pick your words:  [Use arrows to move, type to filter]", core.QuestionIcon.Symbol),
					fmt.Sprintf("  %s  foo", core.UnmarkedOptionIcon.Symbol),
					fmt.Sprintf("  %s  bar", core.MarkedOptionIcon.Symbol),
					fmt.Sprintf("%s %s  baz", core.SelectFocusIcon.Symbol, core.UnmarkedOptionIcon.Symbol),
